...
namespace NETJACKET.Models
{
    public partial class NETJACKETContext : DbContext
    {
        public NETJACKETContext()
        {
        }

        public NETJACKETContext(DbContextOptions<NETJACKETContext> options)
            : base(options)
        {
        }
...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                //optionsBuilder.UseSqlServer("Server=localhost;Initial Catalog=NETJACKET;integrated security=True; TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Compra>(entity =>
            {
                entity.HasKey(e => e.Idcompra)
                    .HasName("PK__Compras__6CA76DB85A8EAF33");
                ...
                entity.HasOne(d => d.PlacaC)
                    ...
                    .HasConstraintName("FK__Compras__Placaco__3A81B327");
            });

            modelBuilder.Entity<Vehiculo>(entity =>
            {
                entity.HasKey(e => e.Placa)
                    .HasName("PK__Vehiculo__8310F99CFBD453DF");
            ...
            modelBuilder.Entity<Venta>(entity =>
            {
                entity.HasKey(e => e.Idventa)
                    .HasName("PK__Ventas__AF5FD380C9390C75");
                ...
                entity.HasOne(d => d.PlacaV)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Ventas__Placaven__3E52440B");
            });
