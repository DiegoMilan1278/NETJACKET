...
namespace NETJACKET.Controllers
{
    public class VentasController : Controller
    {
        ...
        public VentasController(NETJACKETContext context)
        {
            _context = context;
        }
        ...
        {
            var nETJACKETContext = _context.Ventas.Include(v => v.PlacaV);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NETJACKETContext.Ventas'  is null.");
            }
            var venta = await _context.Ventas.FindAsync(id);
            if (venta != null)
            {
