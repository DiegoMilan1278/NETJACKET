...
namespace NETJACKET.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public ComprasController(NETJACKETContext context)
        {
            _context = context;
        }
        ...
        {
            var nETJACKETContext = _context.Compras.Include(c => c.PlacaC);
            return View(await nETJACKETContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["Placacompra"] = new SelectList(_context.Vehiculos, "Placa", "Marca", compra.Placacompra);
            return View(compra);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NETJACKETContext.Compras'  is null.");
            }
            var compra = await _context.Compras.FindAsync(id);
            if (compra != null)
            {
